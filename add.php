...
<html>
    ...
    ?>
        ...
        <center>
            <div class="container">
                <p class="login-text" style="font-size: 2rem; font-weight: 800;">Adicionar Dados</p>
                <form action="" method="POST" class="login-email">
                    ...
                    <div class="input-group">
                        <button name="adiconaradmin" class="btn"> Adicionar</button>          
                    </div>
                </form>
            </div>
        </center>
                ...
                if (preg_match('/\s/', $password)) {
                    ...
                    if ($nivel < 0) {
                        ...
                        if (!$result->num_rows > 0) {
                            $sql = "INSERT INTO `loginregister`(name,email,password,nivel) VALUES('$name', '$email', '$password', '$nivel')";
                            $result = mysqli_query($conn, $sql);
