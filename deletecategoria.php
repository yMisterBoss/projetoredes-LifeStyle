...
<html>
    ...
    -->
        <center>
            <div class="container">
                <p class="login-text" style="font-size: 2rem; font-weight: 800;">Eliminar Categoria</p>
                <form action="" method="POST" class="login-email">
                    <div class="input-group">
                        <input type="numer" placeholder="ID" name="id" value="" required>
                    </div>
                    <div>
                    <p class="login-text"style="font-size: 1.5rem">Ao eliminar a categoria será elimina todos os produtos associados a essa categoria.</p>
                    </div>
                    <div class="input-group">
    ...
    <?php
        include 'basedados/config.php';
         ...
         if (isset($_POST['eliminar'])) {
            ...
            $sql = "DELETE FROM `produtos` WHERE Categoria = $id";
            $result = mysqli_query($conn, $sql);
            ...
            if ($result) { 
                ...
                $result = mysqli_query($conn, $sql);
                if ($result) { 
                    echo "<script>alert('Categoria Eliminado com Sucesso')</script>"; 
