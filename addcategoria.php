...
<html>
    ...
    ?>
        ...
        <center>
            <div class="container">
                <p class="login-text" style="font-size: 2rem; font-weight: 800;">Adicionar Categoria</p>
                <form action="" method="POST" class="login-email">
                    <div class="input-group">
                        <input type="text" placeholder="Categoria" name="categoria" value="" required>
                    </div>
                    <div class="input-group">
                        <button name="adicionarcategoria" class="btn"> Adicionar</button>          
                    </div>
                </form>
            </div>
        </center>
